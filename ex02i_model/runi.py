...
./ex02/runi.py ex02i_model/ conll15-st-03-04-15-dev/ conll15-st-03-04-15-dev/ conll15-st-03-04-15-dev/ ex02i_model/

[2015-05-14 12:40] learning epoch 94 (26.58%), ex02i_model/
[2015-05-14 12:42] learning epoch 94 (51.90%), ex02i_model/
[2015-05-14 12:45] learning epoch 94 (77.22%), ex02i_model/
[2015-05-14 12:46] learning epoch 94 (576.24 sec), rate 2.25e-05, train cost (0.1272 1.0657) avg 0.724394863542
[2015-05-14 12:46]   -0.0135741971501 0.286220908919 0.226543966858
[2015-05-14 12:50] valid set precision 1.00, recall 0.00, f1 0.00   (best 0.0)
[2015-05-16 21:45] learning epoch 200 (26.58%), ex02i_model/
[2015-05-16 21:48] learning epoch 200 (51.90%), ex02i_model/
[2015-05-16 21:52] learning epoch 200 (77.22%), ex02i_model/
[2015-05-16 21:53] learning epoch 200 (730.54 sec), rate 3.48e-08, train cost (0.2323 0.8811) avg 0.635351113881
[2015-05-16 21:53]   -0.13391407914 0.36457559108 0.191740424526
[2015-05-16 21:58] valid set precision 1.00, recall 0.00, f1 0.00   (best 0.0)
[2015-05-18 13:47] learning epoch 364 (26.58%), ex02i_model/
[2015-05-18 13:49] learning epoch 364 (51.90%), ex02i_model/
[2015-05-18 13:52] learning epoch 364 (77.22%), ex02i_model/
[2015-05-18 13:53] learning epoch 364 (564.78 sec), rate 2.76e-11, train cost (0.2566 0.9199) avg 0.63584572869
[2015-05-18 13:53]   -0.124634744128 0.364016548931 0.200205907414
[2015-05-18 13:57] valid set precision 1.00, recall 0.00, f1 0.00   (best 0.0)
"""
...
if __name__ == '__main__':
    ...
    learn_rate = 2.25e-05  # dataset trial=0.01, dev=0.001, train=0.0001
    decay_after = 5
    decay_rate = 0.8
    ...
    rnn = RNN_deep3_wide2_bi(x_dim=x_dim, hidden_dim=hidden_dim, y_dim=y_dim, w_spread=w_spread, p_drop=p_drop)
    rnn.load(args.model_dir, "decay_")

    # iterate through train dataset
    log.info("learning and evaluating")
    decay_cost = 0.724394863542
    decay_epoch = 0
    best_f1 = -np.inf
    best_cost = np.inf
    best_epoch = 0
    ...
    while epoch < epochs and learn_rate > decay_min:
        ...
        log.info("learning epoch {} ({:.2f} sec), rate {:.2e}, train cost ({:.4f} {:.4f}) avg {}{}".format(epoch, time.time() - t, learn_rate, float(cost_min), float(cost_max), cost_avg, (" +" if cost_avg < decay_cost else "  ")))
